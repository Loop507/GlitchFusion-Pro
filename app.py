...
# ==========================
# NUOVA FUNZIONE PER CONTROLLI EFFETTI
# ==========================

def create_effect_controls(name, default_bass, default_mid, default_treble):
    """Crea controlli per gli effetti con intensità massima"""
    with st.container():
        ...
        return bass, mid, treble, max_intensity
                ...
                while cap.isOpened():
                    ...
                    try:
                        ...
                        if enable_shake and bass_value > shake_bass * 0.5:
                            intensity = min(shake_max, bass_value * shake_bass)
